...
export default function Info() {
  ...
  const calculateTimeLeft = () => {
    ...
    const difference = +new Date(`${year}-07-18`) - +new Date();
    let timeLeft = {};
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      >
        Ақтөбе қаласы, <br /> М.Мақатаев 26 <br /> (Озёрная) “Арна” мейрамханасы
      </div>
      <div
        data-aos="fade-up"
      ...
      <a href="https://2gis.kz/aktobe/firm/70000001032595622">
        <Image
          data-aos="fade-up"
          src="/2gis.jpeg"
          alt="2gis"
